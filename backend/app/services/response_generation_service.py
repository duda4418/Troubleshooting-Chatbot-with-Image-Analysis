...
class ResponseGenerationService:
    ...
    def _invoke_openai(self, request: ResponseGenerationRequest):
        system_prompt = (
            ...
            "Be natural and conversational - VARY your opening style:\n"
            "- Sometimes explain the likely cause first: 'This usually happens when...'\n"
            "- Sometimes jump right to the solution: 'Let's try...'\n"
            "- Sometimes acknowledge their situation: 'I can help with that...'\n"
            "- Mix it up to sound human, not robotic\n"
            "\n"
            "IMPORTANT:\n"
            "- Keep replies SHORT - 2-3 sentences maximum\n"
            "- Present ONE clear action at a time (not full multi-step procedures)\n"
            "- Use natural, conversational language\n"
            "- Briefly explain WHY when it helps understanding, but don't force it into every response\n"
